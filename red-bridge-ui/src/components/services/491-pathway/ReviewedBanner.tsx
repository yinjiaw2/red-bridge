...
<div className="mx-auto flex max-w-[1100px] flex-wrap items-center justify-center gap-3 text-center text-[13px] text-muted-foreground">        <CalendarCheck size={15} className="shrink-0 text-primary" />
        <span>
          {t("textBefore")}
