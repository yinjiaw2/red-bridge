    ...
    <section className="w-full border-b border-[var(--border-soft)] bg-[linear-gradient(180deg,var(--bg-card)_0%,var(--bg)_100%)] py-16 md:py-20">
      <div className="home-inner">
        <div className="mx-auto max-w-[940px] text-center">
          <p className="section-eyebrow">Employer Sponsored Visas</p>
          <h1 className="mt-4 font-display text-[3rem] leading-[0.95] text-[var(--text-main)] md:text-[4.25rem]">
            Your Skills <span className="italic text-[var(--accent)]">Deserve</span>
            <br />
            a Real Sponsor
          </h1>
          <p className="mx-auto mt-5 max-w-[780px] text-lg leading-8 text-[var(--text-sub)]">
            The 482 route only works when the employer is real, the nomination is genuine, and the long-term plan is
            built from the start. We verify the sponsor first and then carry the case through to the 186 finish line.
          </p>
