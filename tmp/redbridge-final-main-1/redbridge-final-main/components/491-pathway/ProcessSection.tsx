      ...
      <div className="home-inner">
        <div className="mx-auto max-w-[760px] text-center">
          ...
          <h2 className="mt-3 font-display text-[2.7rem] leading-[0.98] text-[var(--text-main)] md:text-[3.2rem]">
            From First Call to
            <br />
            <span className="italic text-[var(--accent)]">191 Permanent Residency</span>
          </h2>
          <p className="mt-4 text-lg leading-8 text-[var(--text-sub)]">
            The 491 has one extra chapter compared with the 190: the three-year regional period that leads to the 191.
          </p>
        </div>
                  ...
                  className={[
                    ...
                    step.success
                      ...
                      : step.legal
                        ...
                        : step.number === "3yr"
                          ? "bg-[linear-gradient(135deg,#3a604a,#254233)] text-white"
