        ...
        <div className="home-inner">
          <div className="mx-auto max-w-[780px] rounded-[28px] border border-[var(--border-soft)] bg-[var(--bg-card)] px-7 py-10 text-center shadow-[var(--shadow)] md:px-10">
            ...
            <p className="mx-auto mt-5 max-w-[620px] text-base leading-8 text-[var(--text-sub)]">
              Your consultation request is prepared for {selectedSlotLabel}. In this migration pass, the booking flow is
              fully interactive on the client side and ready for backend wiring when you want to reconnect the email,
              OTP, and submission endpoints.
            </p>
